...
<section id="music" class="bg-muted/50 py-20 md:py-28">
	<div class="mx-auto max-w-6xl px-4 md:px-6">
		<div class="mb-12 text-center">
			...
			<h3 class="mb-4 text-3xl text-foreground md:text-4xl">Listen</h3>
			<p class="mx-auto max-w-lg text-base text-muted-foreground md:text-lg">
				Explore Taylor's original music and live recordings.
			</p>
		</div>

		<!-- Placeholder cards for music embeds -->
		...
		<p class="mt-8 text-center text-sm text-muted-foreground">
			Music platform embeds will be added here — Spotify, SoundCloud, YouTube, etc.
		</p>
	</div>
</section>
